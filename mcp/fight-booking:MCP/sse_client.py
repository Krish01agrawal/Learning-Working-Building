#!/usr/bin/env python3
"""
SSE (Server-Sent Events) MCP Client for Flight Booking Server
Uses SSE transport to avoid stdio connection issues
"""
...
async def test_sse_client():
    ...
    try:
        ...
        async with sse_client("http://localhost:8000/mcp") as (read_stream, write_stream):
            ...
            print("\n🎉 All SSE client tests completed!")
            print("🚀 SSE transport is working perfectly!")
